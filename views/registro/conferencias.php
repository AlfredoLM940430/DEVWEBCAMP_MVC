<h2 class="conferencia__heading"><?php echo $titulo; ?></h2>
<p class="conferencia__descripcion">Elige hasta 5 eventos para asistir de manera presencial</p>

<div class="eventos-registro">
    <main class="eventos-registro__listado">
        <h3 class="eventos-registro__heading--conferencias">&lt; Conferencias /></h3>
        <p class="eventos-registro__fecha">Viernes 8 de Diciembre</p>
        ...
        <p class="eventos-registro__fecha">Sabado 9 de Diciembre</p>
        <div class="eventos-registro__grid">
